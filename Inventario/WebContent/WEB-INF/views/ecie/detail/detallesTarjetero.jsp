...
<aek:jsmin>
{
	...
	view: function(){
	   var valeProductoStore = new Ext.data.JsonStore({
		...
		var detallesTarjetero = new Ext.Panel({
			id: 'detallesTarjetero',
			title: 'Tarjetero',
			closable: true,
			height: 400,
			border:false,
				...
				new Ext.form.FormPanel({
					...
					tbar: new Ext.Toolbar({
						...
						
						{
							...
							tooltip:'Imprimir Detalles del Tarjetero',
							listeners:{
								click:function(){
									descargar('../ecie/imprimirDetallesTarjetero.htm', {id: '${command.id}'});
								}			  			
					  		}
						}
					  ]	
