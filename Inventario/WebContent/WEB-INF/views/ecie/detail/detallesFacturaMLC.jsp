...
<aek:jsmin>
{
	...
	view: function(){
		...
		var valeProductoStore = new Ext.data.JsonStore({
    	    ...
    	    id: 'id',
   	    	...
   	    	'totalMN','totalMLC','existenciaOrigen','existenciaDestino','precioVentaMLC']
		});
	...
	/*	var facturaStore = new Ext.data.JsonStore({
            ...
            autoLoad: true,
       	    remoteSort: true,
			baseParams: {limit:20, 'tipo': 'FacturaMLC' },
  	        root: 'data',
    	    totalProperty: 'totalCount',
    	    id: 'id',
		...
		var detallesFacturaGrid = new Ext.grid.GridPanel({
			...
			sm: new Ext.grid.RowSelectionModel({singleSelect:true}),
	       	columns:  [
				...
				{header: "PV CUC", width: 80, dataIndex: 'precioVentaMLC', sortable: true},
				{header: "<b><font color=black> Imp Venta CUP</font></b>", width: 80, dataIndex: 'totalMLC', sortable: true},
				...
				new Ext.form.FormPanel({
					...
					{xtype: 'tbspacer'},
					{
						...
						tooltip:'Imprimir Detalles de la Factura',
							listeners:{
								click:function(){
									descargar('../ecie/impDetallesFactura.htm', { idVale: '${command.id}','tipo': 'FacturaMLC'});
							}			  			
				  		}
					}
