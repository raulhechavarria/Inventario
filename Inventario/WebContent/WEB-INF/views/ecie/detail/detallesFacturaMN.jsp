...
<aek:jsmin>
{
	...
	view: function(){
		...
		var valeProductoStore = new Ext.data.JsonStore({
    	    ...
    	    id: 'id',
   	    	...
   	    	'totalMN','totalMLC','existenciaOrigen','existenciaDestino','precioVentaMN']
		});
	...
	/*	var facturaStore = new Ext.data.JsonStore({
            ...
            autoLoad: true,
       	    remoteSort: true,
			baseParams: {limit:20, 'tipo': 'FacturaMN' },
  	        root: 'data',
    	    totalProperty: 'totalCount',
    	    id: 'id',
		...
		var detallesFacturaGrid = new Ext.grid.GridPanel({
			...
			sm: new Ext.grid.RowSelectionModel({singleSelect:true}),
	       	columns:  [
				...
				{header: "PC CUC", width: 80, dataIndex: 'precioMLCVale', sortable: true},
				{header: "PC CUP", width: 80, dataIndex: 'precioMNVale', sortable: true},
				{header: "PV CUP", width: 80, dataIndex: 'precioVentaMN', sortable: true},
				{header: "<b><font color=black> Imp Venta CUP</font></b>", width: 80, dataIndex: 'totalMN', sortable: true},
				...
				new Ext.form.FormPanel({
					...
					{xtype: 'tbspacer'},
					{
						...
						tooltip:'Imprimir Detalles de la Factura',
							listeners:{
								click:function(){
									descargar('../ecie/impDetallesFactura.htm', { idVale: '${command.id}','tipo': 'FacturaMN'});
							}			  			
				  		}
					}
