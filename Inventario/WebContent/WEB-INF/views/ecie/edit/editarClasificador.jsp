						...
						click:function(){
							if(datosForm.getForm().isValid()){
					 			...
					 			datosForm.form.submit({
						            url : '../${modulo}/adicionarClasificador.htm',
						             params: {
										id: '${command.id}'
									},
		            				...
		            				success: function (form, action) {
										...
										{idclasificador: action.result.id});
										clasificadorGrid = Ext.getCmp('clasificadorGrid');
										clasificadorGrid.getStore().reload();
			            			}
	            				});
	            			}
	            			else{
