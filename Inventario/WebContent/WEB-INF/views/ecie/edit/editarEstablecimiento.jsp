...
<aek:jsmin>
{
	...
	view: function(){
						...
						click:function(){
							if(datosForm.getForm().isValid()){
					 			...
					 			datosForm.form.submit({
						            url : '../${modulo}/adicionarEstablecimiento.htm',
						             params: {
										id: '${command.id}'
									},
		            				...
		            				success: function (form, action) {
										...
										{idestablecimiento: action.result.id});
										establecimientoGrid = Ext.getCmp('establecimientoGrid');
										establecimientoGrid.getStore().reload();
			            			}
	            				});
	            			}
	            			else{
		...
		<c:if test="${empty command.id}">					
			title: 'Adicionar Establecimiento',
		</c:if>
	        resizable: false,                
            closable: true,
            modal: true,                   
